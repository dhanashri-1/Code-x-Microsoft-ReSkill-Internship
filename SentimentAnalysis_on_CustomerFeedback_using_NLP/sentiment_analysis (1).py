...
Original file is located at
    https://colab.research.google.com/drive/1WbmHH6VU0gEi6eykCKD-scK5-0gpKajU
"""
...
ax = df['Score'].value_counts().sort_index() .plot(kind= 'bar', title = 'Count of Reviews by Stars',figsize= (10,5), color ='green')
